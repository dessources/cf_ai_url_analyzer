/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: c74c9374b7093efc64b55e415b7bb93c)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AnalysisStateDO";
	}
	interface Env {
		AI: Ai;
		...
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		ANALYSIS_STATE_DO: DurableObjectNamespace<import("./worker-entrypoint").AnalysisStateDO>;
		WORKER_SELF_REFERENCE: Service<typeof import("./worker-entrypoint").default>;
		URL_ANALYZER_WORKFLOW: Workflow<Parameters<import("./worker-entrypoint").URLAnalyzerWorkflow['run']>[0]['payload']>;
	}
}
